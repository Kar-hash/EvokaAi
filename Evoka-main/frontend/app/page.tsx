...
/**
 * Represents the home page of Evoka AI.
 * Features an interactive terminal-style demo showcasing the platform's capabilities.
 */
          ...
          <div className="border-b border-[#1a1a1a]">
            <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-[#666] text-sm font-mono">evoka_ai@localhost:~</div>
              </div>
                ...
                <div className="relative w-full">
                  ...
                  <div className="relative">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 font-mono text-center">
                      <span className="text-cyan-400">Evoka</span>
