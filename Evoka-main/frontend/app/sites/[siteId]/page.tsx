...
/**
 * Represents the site preview page for Evoka AI.
 * Allows users to view site metadata, navigate structure, and preview pages.
 */
export default function SitePreview() {
  ...
  /**
   * Loads the site data from the API and sets the initial page and HTML.
   */
  ...
  /**
   * Handles page selection and updates the current HTML for preview.
